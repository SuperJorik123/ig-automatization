...
_SYSTEM = (
    ...
    "they are.\n"
    "HASHTAGS ARE NOT TEXT — every #tag is copied through character for "
    "character. Do not translate one, do not transliterate one, do not "
    "localise one, do not reorder them, do not add or drop any. "
    "\"#breakingnews\" stays \"#breakingnews\" in every language. They are the "
    "same tags on every channel, which is the only reason they are worth "
    "anything.\n\n"
